        ...
        return $schema
            ->components([
                ...
                FileUpload::make('gallery')
                    ->label('Wedding Photo Album / Gallery (Multiple Photos)')
                    ->multiple()
                    ->reorderable()
                    ->image()
                    ->disk('public')
                    ->directory('stories/galleries')
                    ->visibility('public')
                    ->helperText('Upload full photo album for this wedding. Visitors can browse through these photos in a lightbox gallery.')
                    ->columnSpanFull(),
