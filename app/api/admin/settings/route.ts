    ...
    if (!setting) {
      setting = await db.websiteSetting.create({
        data: {
          ...
          color_grade_heading: "Raw Capture vs. Paneventz Signature Grade",
          color_grade_description: "Every celebration is masterfully developed with custom Paneventz color science, delicate highlight roll-offs, and authentic 35mm film warmth that stands the test of time.",
          color_grade_before_image: "/images/signature-color-grade.jpg.orig",
